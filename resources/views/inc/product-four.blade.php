        ...
        <div class="row">
            ...
            <div class="col-md-4 col-xs-12 pr-4-img-div-col" style="padding:15px">
                <div class="col-xs-12 pr-4-img-div">
                    <div>
                        <img src="pilotpublic/images/bus/p1.jpeg" style="height:250px; width:100%">
                    </div>
            ...
            <div class="col-md-4 col-xs-12 pr-4-img-div-col" style="padding:15px">
                <div class="col-xs-12 pr-4-img-div">
                    <div>
                        <img src="pilotpublic/images/bus/p2.jpeg" style="height:250px; width:100%">
                    </div>
                    <div class="col-xs-12 pr-4-img-div-txt">
                        BOOK YOUR RIDE:
                        <div class="row" style="margin-top:10px">
            ...
            <div class="col-md-4 col-xs-12 pr-4-img-div-col" style="padding:15px">
                <div class="col-xs-12 pr-4-img-div">
                    <div>
                        <img src="pilotpublic/images/bus/p3.jpeg" style="height:250px; width:100%">
                    </div>
                    <div class="col-xs-12 pr-4-img-div-txt">
                        BOOK YOUR RIDE:
                        <div class="row" style="margin-top:10px">
