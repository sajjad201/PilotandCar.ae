...
<section class="bg-img-int bg-pic" style="background-image: url(pilotpublic/images/airport/g6.webp); height: 500px;">

<div class="bg-txt-cnt">
<div class="bg-txt-inner animated zoomIn" style="    background-color: rgba(255, 255, 255, 0.9);  ">
    <h1 class="text-center animated fadeInDown" style="font-weight:700; animation-delay: .5s;">Dubai International Airport</h1>
  <p class="text-center animated fadeInUp" style="animation-delay: 1s;">
    Pilot and Cars will arrange your Dubai airport transport and save you time once you land.  
...
<section>
  <div class="six-img-into">
      <img src="pilotpublic/images/airport/door.jpg" class="image-object" style="height:130px; width:100%">
    <div class="six-img-into-inner">Travel to DUBAI INTERNATIONAL AIRPORT</div>
  </div>
</section>
...
<section class="os6-sec wrapper">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <img src="pilotpublic/images/airport/g10.jpg" class="img-fluid" style="height:450px; width:100%"><br><br><br>
      ...
      <div class="row gal-cnt">
        ...
        <div class="col-md-4" style="padding: 5px;">
          <img src="pilotpublic/images/airport/p3.jpg" class="gal-img">
        </div>
      </div>
      <div class="row gal-cnt">
        ...
        <div class="col-md-5" style="padding: 5px;">
          <img src="pilotpublic/images/airport/g9.jpg" class="gal-img">
        </div>
      </div>
      <br><br><br>
      <h1 class="os6-h1" style="font-size:36px; font-weight:700">FIXED & GUARANTED RATES UNTIL YOUR DESTINATION</h1>
      <img src="pilotpublic/images/airport/b3.jpg" class="object-image" style="height:550px">
      <p class="os6-p" style="font-family: calibri;">
          <div class="os6-p" style="font-family: calibri; font-weight:600">- CALL OUR DESKTOP HELP 24/7</div> 
          <p class="os6-p" style="font-family: calibri;">
      ...
      <div class="row">
        <div class="col-md-8" style="padding: 5px;">
          <img src="pilotpublic/images/airport/b1.jpg" class="gal-img">
        </div>
        <div class="col-md-4" style="padding: 5px;">
          <img src="pilotpublic/images/gal3.jpg" class="gal-img">
        </div>
      ...
      <div class="row">
        <div class="col-md-4" style="padding: 5px;">
          <img src="pilotpublic/images/airport/b0.jpg" class="gal-img">
        </div>
        <div class="col-md-8" style="padding: 5px;">
          <img src="pilotpublic/images/airport/g5.jpg" class="gal-img">
        </div>
      </div>
      <p class="os6-p" style="font-family: calibri;">
