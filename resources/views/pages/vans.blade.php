...
<section>
  <div style="position:relative">
    <img src="pilotpublic/images/van/p2.jpg" class="img-b" style="height:600px">
    <div style="position:absolute; left:18%; top:30%">
      <h1 style="text-shadow: 2px 2px 2px lightgrey; color:white; font-size:70px" class="three animate">
        <strong>
          <span>C</span><span>H</span><span>E</span><span>C</span><span>K</span><span>O</span><span>U</span><span>T</span> <span>V</span><span>A</span><span>N</span><span> </span><span>S</span><span>E</span><span>R</span><span>V</span><span>I</span><span>C</span><span>E</span><span>S</span> 
      </strong>
      </h1>
    <div>
  </div>
    ...
    <div class="row">
      <div class="col-md-12 page-nav-links-col">
        ...
        <div class="page-nav-links-col-internal-current">
          <a href="{{url('#')}}">Luxury Van Services <i class="fas fa-chevron-right page-nav-links-col-internal-icon"></i></a>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        ...
        <div class="row">
          <div class="col-lg-8 st-ten-cards-one" style="padding:0px 5px;">
            <img src="pilotpublic/images/van/g6.jpg" style="height:100%; width:100%;object-fit: cover;">
        ...
        <div class="row" style="margin-top:10px">
          ...
          <div class="col-lg-8 st-ten-cards-one" style="padding:0px 5px;">
            <img src="pilotpublic/images/van/p2.jpg" style="height:100%; width:100%;object-fit: cover;">
            <div class="st-ten-cards-one-text1">
      ...
      <div class="row os-10-shadow">
          ...
          <div class="os10-cnt">
            ...
            <div class="col-md-6 pl-0 pr-0">
              <div class="os10-img-cnt">
                <img src="pilotpublic/images/van/p1.jpg" class="img-fluid obj-cover">
              </div>
            </div>
          </div>
          </div>
        ...
        <div class="col-md-6">
          ...
          <div class="os10-cnt">
            ...
            <div class="col-md-6 pl-0 pr-0">
              <div class="os10-img-cnt">
                <img src="pilotpublic/images/van/g2.jpg" class="img-fluid obj-cover">
              </div>
            </div>
          </div>
          </div>
        ...
        <div class="col-md-6">
          ...
          <div class="os10-cnt">
            ...
            <div class="col-md-6 pl-0 pr-0">
              <div class="os10-img-cnt">
                <img src="pilotpublic/images/van/p3.jpg" class="img-fluid obj-cover">
              </div>
            </div>
          </div>
          </div>
        ...
        <div class="col-md-6">
          ...
          <div class="os10-cnt">
            ...
            <div class="col-md-6 pl-0 pr-0">
              <div class="os10-img-cnt">
                <img src="pilotpublic/images/van/b3.jpg" class="img-fluid  obj-cover">
              </div>
            </div>
          </div>
          </div>
        ...
        <div class="col-md-12" style="padding:0px">
            <div style="background-color: #fbfbfb; text-align:center">
                ...
                <div class="container link-card__card-container link-card__card-container-mb ">
                    ...
                    <a href="rent-a-car-with-driver" target="_blank" class="context-item link-card__item hover--move-up">
